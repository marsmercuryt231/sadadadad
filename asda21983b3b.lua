...
while true do
    ...
    while raidCaveExists() do
        ...
        if not encounterFiring and not isGeohopping and not isTeleportingToGate and not isHoppingTime and not hasBattleGui and mainGui.OutsetContainerBeyondSafe:FindFirstChild("FadeGui") == 1 then
